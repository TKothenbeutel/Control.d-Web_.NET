...
const Star = (props) => (
    <div style={starStyle}>
        <img src={props.rating>=props.threshold-0.5 ? SvgStarFillLeft : SvgStarLeft} style={starHalf} draggable="false" alt="left half star"
            onClick={props.clickable ? () => props.clickable(props.threshold-0.5) : undefined}/>
        <img src={props.rating>=props.threshold ? SvgStarFillRight : SvgStarRight} style={starHalf} draggable="false" alt="right half star"
