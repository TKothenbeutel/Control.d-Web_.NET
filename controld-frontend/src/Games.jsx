...
export async function favoriteGameToggle(favorited, accId, game){
    if(favorited){
      return await fetch(DB_API + `/Account/${accId}/FavoriteGame/${game.gameId}`, { method: "DELETE" })
        .then(results => {
      ...
      return await fetch(DB_API + `/Account/${accId}/FavoriteGame`, {
        method: "PUT",
        headers: {
...
export function GamePage(props) {
  ...
  const handleFavorite = () => {
    setFavorited(favoriteGameToggle(favorited, accountId, {...game, gameId : gameId}));
  };
